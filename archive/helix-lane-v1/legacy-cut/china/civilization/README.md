...
Use the present-day arc extension matrix when a China read needs to bridge older mandate, order, unity, humiliation, or restoration arcs into modern carriers such as compute sovereignty, industrial capacity, ports, insurers, maritime ambiguity, Taiwan quarantine logic, or party-state implementation.

For China-specific order analysis, use the China order arc to distinguish mandate-order, standardization-order, hydraulic-order, fragmentation-memory, development-order, party-state-order, and compute-order before turning stability or unity claims into clause language.
